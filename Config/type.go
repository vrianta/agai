...
type (
	...
	class struct {
		...
		StaticFolder []string `json:"StaticFolder"` // static folders list which comes with a list of scrigs for all the static folder which needs to be in file server
